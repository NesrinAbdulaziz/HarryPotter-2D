...
import harrypotter.view.winners;
		...
		if (!winners.isEmpty()) {
			...
			Timer t = new Timer(1000,new ActionListener() {
				...
				public void actionPerformed(ActionEvent e1) {
						try {
							new winners(winners,1);
						} catch (IOException | LineUnavailableException | UnsupportedAudioFileException e) {
							// TODO Auto-generated catch block
							e.printStackTrace();
						}
						firstTask.cont.startSecond(winners);
	...
	public void onFinishingSecondTask(ArrayList<Champion> winners)
		...
		if (!winners.isEmpty()) {
			...
			Timer t = new Timer(1000,new ActionListener() {
				...
				public void actionPerformed(ActionEvent e1) {
					try {
						new winners(winners,2);
					} catch (IOException | LineUnavailableException | UnsupportedAudioFileException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
					firstTask.cont.startThird(winners);
	...
	public void onFinishingThirdTask(Champion winner) {
		...
		t= new Timer(3000,new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				thirdTask.cont.getView().dispose();
				System.exit(0);
